...
<br>
<center><h2 style="font-family: 'Times New Roman', Times, serif"> All GCP Questions</h2></center><br>
<center><button type="button" onclick="location.href='allquestions.php'" class="btn btn-light">All AWS Question</button>&nbsp;&nbsp;<button type="button" onclick="location.href='allquestions1.php'" class="btn btn-light">All GCP Question</button></center></center><br>
	...
	<table class="data-table">
        ...
        <?php 
            ...
            while ($row = mysqli_fetch_array($select_questions)) {
                ...
                echo "<td>$option4</td>";
                echo "<td>$Answer</td>";
                echo "<td> <a href='editquestion1.php?qno=$qno'> Edit </a></td>";
				echo "<td> <a href='delete1.php?qid=$qid'>Delete</a></td>";
