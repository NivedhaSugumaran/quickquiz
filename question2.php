...
if (isset($_SESSION['id'])) {
	...
	if (isset($_GET['q']) && is_numeric($_GET['q'])) {
	        ...
	        if ($qno == 1) {
	        	...
	        	header('location: question2.php?q='.$_SESSION['quiz']);
	        } 
			...
			if (mysqli_num_rows($run) > 0) {
				...
				echo "<script> alert('something went wrong in gcp');
...
?>
<?php 
$total = "SELECT * FROM gcpquestions ";
...
<?php 
 ...
 <div class="panel-footer">
				...
				<input type="hidden" name="number1" value="<?php echo $qno;?>">
