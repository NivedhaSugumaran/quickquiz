    ...
    <a href="exit.php">Logout</a>
		...
		<main>
			...
			<h2>Congratulations!</h2> 
				...
				<p>Total points: <?php if (isset($_SESSION['score1'])) {
echo $_SESSION['score1']; 
}; ?> </p>
<button type="button" onclick="location.href='question2.php?q=1'" class="btn btn-light">Start Again</button>
<button type="button" onclick="location.href='category.php'" class="btn btn-light">Go Back</button>
<button type="button" onclick="location.href='table2.php'" class="btn btn-light">View Answers</button>
		...
		$query = "UPDATE users SET score1 = '$score' WHERE email = '$email'";
