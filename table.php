...
<h1><span class="blue">AWS ANSWERS</span></h1> 
...
<br>
	<?php	echo $_SESSION['email']; ?>
                        ...
                        <center>  <input type="submit" name="generate_pdf"  class="btn btn-success" onclick="location.href='trial.php?n'"  value="Generate PDF" />  </center>
                    <br>
