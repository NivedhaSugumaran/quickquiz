...
if(isset($_POST["qno"]) && !empty($_POST["qno"])){
    ...
    $sql = "DELETE FROM gcpquestions WHERE qno = ?";
 ...
 //set @autoid:=0 ;UPDATE questions set qno= @autoid:= (@autoid +1) ;ALTER table questions Auto_increment=1;
